...
@router.post("/api/source/authenticate")
async def source_authenticate(
    ...
    soap_url = body.instanceUrl.rstrip("/") + "/nl/jsp/soaprouter.jsp"
    ...
    if conn:
        ...
        conn.instance_url = body.instanceUrl
    ...
    response.set_cookie(key="acc_user", value=body.loginId, httponly=True, samesite="lax",
